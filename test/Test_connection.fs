...
let expect_message_from_reader reader bin_reader expected =
    Transport.Reader.For_testing.consume_one_transport_message reader [ Bin_prot_reader.expect bin_reader expected ]
...
let create
    ...
    Transport.Writer.send_bin_prot_exn test_transport.writer Protocol_version_header.bin_writer_t protocol_header
    ...
    expect_message_from_reader test_transport.reader Protocol_version_header.bin_reader_t protocol_header

    expect_message_from_reader test_transport.reader Message.bin_reader_nat0_t Message.t.Heartbeat
